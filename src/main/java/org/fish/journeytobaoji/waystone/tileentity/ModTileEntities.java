package org.fish.journeytobaoji.waystone.tileentity;
...
public class ModTileEntities {
    ...
    public static void register(IForgeRegistry<TileEntityType<?>> registry) {
        ...
        registry.registerAll(
                ...
                portstone = build(PortstoneTileEntity::new, new ResourceLocation(Waystones.MOD_ID, "portstone"), ModBlocks.portstone)
        );
    }
